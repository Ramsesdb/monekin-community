...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  // Translations
  late final TranslationsUiActionsEn ui_actions = TranslationsUiActionsEn._(
    _root,
  );
  ...
  late final TranslationsFinancialHealthEn financial_health =
      TranslationsFinancialHealthEn._(_root);
  late final TranslationsStatsEn stats = TranslationsStatsEn._(_root);
  late final TranslationsIconSelectorEn icon_selector =
      TranslationsIconSelectorEn._(_root);
  late final TranslationsTransactionEn transaction =
      TranslationsTransactionEn._(_root);
  late final TranslationsTransferEn transfer = TranslationsTransferEn._(_root);
  late final TranslationsRecurrentTransactionsEn recurrent_transactions =
      TranslationsRecurrentTransactionsEn._(_root);
  late final TranslationsAccountEn account = TranslationsAccountEn._(_root);
  late final TranslationsCurrenciesEn currencies = TranslationsCurrenciesEn._(
    _root,
  );
  ...
  late final TranslationsTargetTimelineStatusesEn target_timeline_statuses =
      TranslationsTargetTimelineStatusesEn._(_root);
...
class TranslationsGeneralEn {
  ...
  late final TranslationsGeneralLeaveWithoutSavingEn leave_without_saving =
      TranslationsGeneralLeaveWithoutSavingEn._(_root);
  late final TranslationsGeneralClipboardEn clipboard =
      TranslationsGeneralClipboardEn._(_root);
  late final TranslationsGeneralTimeEn time = TranslationsGeneralTimeEn._(
    _root,
  );
  late final TranslationsGeneralTransactionOrderEn transaction_order =
      TranslationsGeneralTransactionOrderEn._(_root);
  late final TranslationsGeneralValidationsEn validations =
      TranslationsGeneralValidationsEn._(_root);
}
...
class TranslationsFinancialHealthEn {
  ...
  late final TranslationsFinancialHealthReviewEn review =
      TranslationsFinancialHealthReviewEn._(_root);
  late final TranslationsFinancialHealthMonthsWithoutIncomeEn
  months_without_income = TranslationsFinancialHealthMonthsWithoutIncomeEn._(
    _root,
  );
  late final TranslationsFinancialHealthSavingsPercentageEn savings_percentage =
      TranslationsFinancialHealthSavingsPercentageEn._(_root);
}
...
class TranslationsStatsEn {
  ...
  String get balance_by_currency_subtitle =>
      'How much money do I have in foreign currency?';
...
class TranslationsIconSelectorEn {
  ...
  late final TranslationsIconSelectorScopesEn scopes =
      TranslationsIconSelectorScopesEn._(_root);
}
...
class TranslationsTransactionEn {
  ...
  late final TranslationsTransactionNextPaymentsEn next_payments =
      TranslationsTransactionNextPaymentsEn._(_root);
  late final TranslationsTransactionListEn list =
      TranslationsTransactionListEn._(_root);
  late final TranslationsTransactionFiltersEn filters =
      TranslationsTransactionFiltersEn._(_root);
  late final TranslationsTransactionFormEn form =
      TranslationsTransactionFormEn._(_root);
  late final TranslationsTransactionReversedEn reversed =
      TranslationsTransactionReversedEn._(_root);
  late final TranslationsTransactionStatusEn status =
      TranslationsTransactionStatusEn._(_root);
  late final TranslationsTransactionTypesEn types =
      TranslationsTransactionTypesEn._(_root);
}
...
class TranslationsTransferEn {
  ...
  late final TranslationsTransferFormEn form = TranslationsTransferFormEn._(
    _root,
  );
}
...
class TranslationsRecurrentTransactionsEn {
  ...
  late final TranslationsRecurrentTransactionsDetailsEn details =
      TranslationsRecurrentTransactionsDetailsEn._(_root);
  late final TranslationsRecurrentTransactionsStatusEn status =
      TranslationsRecurrentTransactionsStatusEn._(_root);
}
...
class TranslationsAccountEn {
  ...
  String get no_accounts =>
      'No accounts found to display here. Add an account by clicking the \'+\' button at the bottom';

  late final TranslationsAccountTypesEn types = TranslationsAccountTypesEn._(
    _root,
  );
  late final TranslationsAccountFormEn form = TranslationsAccountFormEn._(
    _root,
  );
  late final TranslationsAccountDeleteEn delete = TranslationsAccountDeleteEn._(
    _root,
  );
  late final TranslationsAccountCloseEn close = TranslationsAccountCloseEn._(
    _root,
  );
  late final TranslationsAccountSelectEn select = TranslationsAccountSelectEn._(
    _root,
  );
}
...
class TranslationsCurrenciesEn {
  ...
  late final TranslationsCurrenciesExchangeRateFormEn exchange_rate_form =
      TranslationsCurrenciesExchangeRateFormEn._(_root);
  late final TranslationsCurrenciesTypesEn types =
      TranslationsCurrenciesTypesEn._(_root);
  late final TranslationsCurrenciesCurrencyFormEn currency_form =
      TranslationsCurrenciesCurrencyFormEn._(_root);
  ...
  String get historical_empty =>
      'No historical exchange rates found for this currency';
...
class TranslationsTagsEn {
  ...
  late final TranslationsTagsSelectEn select = TranslationsTagsSelectEn._(
    _root,
  );
...
class TranslationsCategoriesEn {
  ...
  late final TranslationsCategoriesSelectEn select =
      TranslationsCategoriesSelectEn._(_root);
}
...
class TranslationsBudgetsEn {
  ...
  late final TranslationsBudgetsFormEn form = TranslationsBudgetsFormEn._(
    _root,
  );
  late final TranslationsBudgetsDetailsEn details =
      TranslationsBudgetsDetailsEn._(_root);
  late final TranslationsBudgetsTargetTimelineStatusesEn
  target_timeline_statuses = TranslationsBudgetsTargetTimelineStatusesEn._(
    _root,
  );
  late final TranslationsBudgetsProgressEn progress =
      TranslationsBudgetsProgressEn._(_root);
}
...
class TranslationsGoalsEn {
  ...
  String get delete_warning =>
      'This action is irreversible. Categories and transactions referring to this goal will not be deleted';

  late final TranslationsGoalsFormEn form = TranslationsGoalsFormEn._(_root);
  late final TranslationsGoalsDetailsEn details = TranslationsGoalsDetailsEn._(
    _root,
  );
  late final TranslationsGoalsTargetTimelineStatusesEn
  target_timeline_statuses = TranslationsGoalsTargetTimelineStatusesEn._(_root);
  late final TranslationsGoalsProgressEn progress =
      TranslationsGoalsProgressEn._(_root);
}
...
class TranslationsBackupEn {
  ...
  late final TranslationsBackupExportEn export = TranslationsBackupExportEn._(
    _root,
  );
  late final TranslationsBackupImportEn import = TranslationsBackupImportEn._(
    _root,
  );
  late final TranslationsBackupAboutEn about = TranslationsBackupAboutEn._(
    _root,
  );
}
...
class TranslationsSettingsEn {
  ...
  late final TranslationsSettingsSecurityEn security =
      TranslationsSettingsSecurityEn._(_root);
  late final TranslationsSettingsTransactionsEn transactions =
      TranslationsSettingsTransactionsEn._(_root);
...
class TranslationsMoreEn {
  ...
  late final TranslationsMoreAboutUsEn about_us = TranslationsMoreAboutUsEn._(
    _root,
  );
  late final TranslationsMoreHelpUsEn help_us = TranslationsMoreHelpUsEn._(
    _root,
  );
}
...
class TranslationsGeneralTimeEn {
  ...
  late final TranslationsGeneralTimeRangesEn ranges =
      TranslationsGeneralTimeRangesEn._(_root);
  late final TranslationsGeneralTimePeriodicityEn periodicity =
      TranslationsGeneralTimePeriodicityEn._(_root);
  late final TranslationsGeneralTimeCurrentEn current =
      TranslationsGeneralTimeCurrentEn._(_root);
  late final TranslationsGeneralTimeAllEn all = TranslationsGeneralTimeAllEn._(
    _root,
  );
}
...
class TranslationsFinancialHealthReviewEn {
  ...
  late final TranslationsFinancialHealthReviewDescrEn descr =
      TranslationsFinancialHealthReviewDescrEn._(_root);
}
...
class TranslationsFinancialHealthSavingsPercentageEn {
  ...
  late final TranslationsFinancialHealthSavingsPercentageTextEn text =
      TranslationsFinancialHealthSavingsPercentageTextEn._(_root);
...
class TranslationsTransactionListEn {
  ...
  String get empty =>
      'No transactions found to display here. Add a few transactions in the app and maybe you\'ll have better luck next time.';
  ...
  late final TranslationsTransactionListBulkEditEn bulk_edit =
      TranslationsTransactionListBulkEditEn._(_root);
}
...
class TranslationsTransactionFiltersEn {
  ...
  late final TranslationsTransactionFiltersSavedEn saved =
      TranslationsTransactionFiltersSavedEn._(_root);
}
...
class TranslationsTransactionFormEn {
  ...
  // Translations
  late final TranslationsTransactionFormValidatorsEn validators =
      TranslationsTransactionFormValidatorsEn._(_root);
  ...
  String get description_info =>
      'Tap here to enter a more detailed description about this transaction';
...
class TranslationsTransactionReversedEn {
  ...
  String get description_for_expenses =>
      'Despite being an expense transaction, it has a positive amount. These types of transactions can be used to represent the return of a previously recorded expense, such as a refund or having the payment of a debt.';
  ...
  String get description_for_incomes =>
      'Despite being an income transaction, it has a negative amount. These types of transactions can be used to void or correct an income that was incorrectly recorded, to reflect a return or refund of money or to record payment of debts.';
}
...
class TranslationsTransferFormEn {
  ...
  late final TranslationsTransferFormValueInDestinyEn value_in_destiny =
      TranslationsTransferFormValueInDestinyEn._(_root);
}
...
class TranslationsCurrenciesExchangeRateFormEn {
  ...
  String get override_existing_warn =>
      'An exchange rate for this currency in this date already exists. If you continue, the previous one will be overwritten';
  ...
  String get remove_all_warning =>
      'This action is irreversible and will delete all exchange rates for this currency';
}
...
class TranslationsCurrenciesCurrencyFormEn {
  ...
  String get already_exists =>
      'A currency with this code already exists. You may want to edit it';
}
...
class TranslationsBudgetsProgressEn {
  ...
  // Translations
  late final TranslationsBudgetsProgressLabelsEn labels =
      TranslationsBudgetsProgressLabelsEn._(_root);
  late final TranslationsBudgetsProgressDescriptionEn description =
      TranslationsBudgetsProgressDescriptionEn._(_root);
}
...
class TranslationsGoalsTypeEn {
  ...
  late final TranslationsGoalsTypeIncomeEn income =
      TranslationsGoalsTypeIncomeEn._(_root);
  late final TranslationsGoalsTypeExpenseEn expense =
      TranslationsGoalsTypeExpenseEn._(_root);
}
...
class TranslationsGoalsDetailsEn {
  ...
  String get no_transactions =>
      'It seems that you have not made any transactions related to this goal';
}
...
class TranslationsGoalsProgressEn {
  ...
  // Translations
  late final TranslationsGoalsProgressLabelsEn labels =
      TranslationsGoalsProgressLabelsEn._(_root);
  late final TranslationsGoalsProgressDescriptionEn description =
      TranslationsGoalsProgressDescriptionEn._(_root);
}
...
class TranslationsBackupImportEn {
  ...
  late final TranslationsBackupImportManualImportEn manual_import =
      TranslationsBackupImportManualImportEn._(_root);
...
class TranslationsSettingsGeneralEn {
  ...
  late final TranslationsSettingsGeneralLanguageEn language =
      TranslationsSettingsGeneralLanguageEn._(_root);
  late final TranslationsSettingsGeneralLocaleEn locale =
      TranslationsSettingsGeneralLocaleEn._(_root);
}
...
class TranslationsSettingsSecurityEn {
  ...
  String get private_mode_at_launch_descr =>
      'Launch the app in private mode by default';
...
class TranslationsSettingsTransactionsEn {
  ...
  late final TranslationsSettingsTransactionsStyleEn style =
      TranslationsSettingsTransactionsStyleEn._(_root);
  late final TranslationsSettingsTransactionsSwipeActionsEn swipe_actions =
      TranslationsSettingsTransactionsSwipeActionsEn._(_root);
  late final TranslationsSettingsTransactionsDefaultValuesEn default_values =
      TranslationsSettingsTransactionsDefaultValuesEn._(_root);
  late final TranslationsSettingsTransactionsDefaultTypeEn default_type =
      TranslationsSettingsTransactionsDefaultTypeEn._(_root);
}
...
class TranslationsSettingsAppearanceEn {
  ...
  String get menu_descr =>
      'Theme selection, colors and other things related to the app appearance';

  /// en: 'Theme and colors'
  String get theme_and_colors => 'Theme and colors';

  late final TranslationsSettingsAppearanceThemeEn theme =
      TranslationsSettingsAppearanceThemeEn._(_root);
...
class TranslationsMoreAboutUsEn {
  ...
  String get description =>
      'Find Monekin’s terms, important info, and connect by reporting bugs or sharing ideas';

  late final TranslationsMoreAboutUsLegalEn legal =
      TranslationsMoreAboutUsLegalEn._(_root);
  late final TranslationsMoreAboutUsProjectEn project =
      TranslationsMoreAboutUsProjectEn._(_root);
}
...
class TranslationsGeneralTimeRangesEn {
  ...
  late final TranslationsGeneralTimeRangesTypesEn types =
      TranslationsGeneralTimeRangesTypesEn._(_root);
...
class TranslationsTransactionFormValidatorsEn {
  ...
  String get transfer_between_same_accounts =>
      'The origin and the destination account cannot be the same';
}
...
class TranslationsBudgetsProgressDescriptionEn {
  ...
  String active_on_track({
    ...
    required Object remainingDays,
      ...
      'You can spend ${dailyAmount} per day for the remaining ${remainingDays} days';
  ...
  String active_overspending({
    ...
    required Object remainingDays,
      ...
      'To get back on track, you should limit your spending to ${dailyAmount} per day for the remaining ${remainingDays} days';

  /// en: 'You have {{ amount }} left to spend.'
  String active_indeterminate({required Object amount}) =>
      'You have ${amount} left to spend.';
  ...
  String active_exceeded({required Object amount}) =>
      'You have already exceeded your budget limit by ${amount}. If you don\'t find any incomes for this budget, you should stop spending for the rest of its period';

  /// en: 'Great job! This budget has already finish successfully. Keep creating budgets to manage your expenses'
  String get success =>
      'Great job! This budget has already finish successfully. Keep creating budgets to manage your expenses';

  /// en: 'You exceeded the budget by {{ amount }}. Try to be more careful next time!'
  String fail({required Object amount}) =>
      'You exceeded the budget by ${amount}. Try to be more careful next time!';
}
...
class TranslationsGoalsTypeIncomeEn {
  ...
  String get descr =>
      'Ideal for saving money. You succeed when the balance goes above your target.';
}
...
class TranslationsGoalsTypeExpenseEn {
  ...
  String get descr =>
      'Track how much you spend and aim to reach a target amount. Works good for donations, charity, leisure spending...';
}
...
class TranslationsGoalsProgressDescriptionEn {
  ...
  String active_on_track({
    ...
    required Object remainingDays,
      ...
      'You are on track to seek your goal! You have to save ${dailyAmount} per day for the remaining ${remainingDays} days';
  ...
  String active_behind_schedule({
    ...
    required Object remainingDays,
      ...
      'You are behind schedule. You have to save ${dailyAmount} per day to reach your goal in ${remainingDays} days';

  /// en: 'You need {{ amount }} more to reach your goal.'
  String active_indeterminate({required Object amount}) =>
      'You need ${amount} more to reach your goal.';
...
class TranslationsSettingsGeneralLanguageEn {
  ...
  String get help =>
      'If you want to collaborate with the translations of this app, you can consult <a href=\'https://github.com/enrique-lozano/Monekin/tree/main/lib/i18n\'>our guide</a>';
}
...
class TranslationsSettingsTransactionsStyleEn {
  ...
  String get subtitle =>
      'Configure how transactions look in the different lists of the app';
...
class TranslationsSettingsTransactionsSwipeActionsEn {
  ...
  String get choose_description =>
      'Choose what action will be triggered when you swipe a transaction item in the list using this swipe direction';
...
extension on Translations {
  ...
  Map<String, dynamic> _initFlatMap() {
    ...
    map['general.validations.form_error'] =
        'Fix the indicated fields to continue';
    ...
    map['financial_health.savings_percentage.subtitle'] =
        'What part of your income is not spent in this period';
    ...
    map['stats.balance_by_account_subtitle'] =
        'Where do I have most of my money?';
    ...
    map['transaction.next_payments.skip_success'] =
        'Successfully skipped transaction';
    ...
    map['transaction.next_payments.accept_in_required_date'] =
        ({required Object date}) => 'Accept in required date (${date})';
    ...
    map['transaction.form.validators.zero'] =
        'The value of a transaction cannot be equal to zero';
    ...
    map['transaction.form.exchange_to_preferred_title'] =
        ({required Object currency}) => 'Exchnage rate to ${currency}';
    ...
    map['transaction.status.none_descr'] =
        'Transaction without a specific state';
    ...
    map['transfer.form.value_in_destiny.title'] =
        'Amount transferred at destination';
    map['transfer.form.value_in_destiny.amount_short'] =
        ({required Object amount}) => '${amount} to target account';
    ...
    map['currencies.delete_all_success'] =
        'Deleted exchange rates successfully';
    ...
    map['budgets.form.negative_warn'] =
        'The budgets can not have a negative amount';
    ...
    map['budgets.progress.description.active_indeterminate'] =
        ({required Object amount}) => 'You have ${amount} left to spend.';
    ...
    map['goals.progress.description.fail'] = ({required Object amount}) =>
        'You missed your goal by ${amount}.';
    ...
    map['backup.import.manual_import.descr'] =
        'Import transactions from a .csv file manually';
    ...
    map['settings.general.locale.descr'] =
        'Set the format to use for dates, numbers...';
    map['settings.general.locale.warn'] =
        'When changing region the app will update';
    ...
    map['settings.transactions.menu_descr'] =
        'Configure the behavior of your transactions';
